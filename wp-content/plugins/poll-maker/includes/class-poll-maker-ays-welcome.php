                ...
                <div class="poll-maker-welcome-container">
                    ...
                    <div class="poll-maker-welcome-intro">
                        ...
                        <div class="poll-maker-welcome-logo">
                            <img src="<?php echo POLL_MAKER_AYS_ADMIN_URL; ?>/images/icons/poll-maker-logo.png" alt="<?php echo __( 'Poll Maker Logo', POLL_MAKER_AYS_NAME ); ?>">
                        </div>

                        <div class="poll-maker-welcome-close">
                            <a href="<?php echo admin_url( 'admin.php?page=' . POLL_MAKER_AYS_NAME ) ?> ">
                                <img src="<?php echo POLL_MAKER_AYS_ADMIN_URL; ?>/images/icons/close.svg" alt="<?php echo __( 'Close', POLL_MAKER_AYS_NAME ); ?>">
                            </a>
                        </div>
                        <div class="poll-maker-welcome-block">
                            <h1><?php echo __( 'Welcome to Poll Maker', POLL_MAKER_AYS_NAME ); ?></h1>
                            <h6><?php echo __( 'Thank you for choosing Poll Maker - the best poll and survey plugin for WordPress.', POLL_MAKER_AYS_NAME ); ?></h6>
                        </div>
        
                        <a href="#" class="play-video" title="<?php esc_attr_e( 'Watch how to create your first poll', POLL_MAKER_AYS_NAME ); ?>">
                            <img src="<?php echo POLL_MAKER_AYS_ADMIN_URL; ?>/images/ays-poll-welcome-video.png" alt="<?php echo __( 'Watch how to create your first poll', POLL_MAKER_AYS_NAME ); ?>" class="poll-maker-welcome-video-thumbnail">
                        </a>
                            ...
                            <div class="poll-maker-welcome-button-wrap poll-maker-clear">
                                <div class="poll-maker-welcome-left">
                                    <a href="<?php echo esc_url( admin_url( 'admin.php?page=' . POLL_MAKER_AYS_NAME . "&action=add") ); ?>" class="poll-maker-btn poll-maker-btn-block poll-maker-btn-lg poll-maker-btn-orange">
                                        <?php echo __( 'Create Your First Poll', POLL_MAKER_AYS_NAME ); ?>
                                    </a>
                                </div>
                                <div class="poll-maker-welcome-right">
                                    <a href="<?php echo 'https://ays-pro.com/wordpress-poll-maker-user-manual'; ?>"
                                        ...
                                        <?php echo __( 'Documentation', POLL_MAKER_AYS_NAME ); ?>
                                    </a>
                                </div>
                            </div>
