...
$poll_message_vars = array(
    ...
    '%%poll_title%%'      				=> __("Poll title", $this->plugin_name),
    '%%users_first_name%%'     			=> __("User's First Name", $this->plugin_name),
    '%%users_last_name%%'       		=> __("User's Last Name", $this->plugin_name),
    '%%creation_date%%'       			=> __("Creation date of the poll", $this->plugin_name),
    '%%current_poll_author%%'   		=> __("Author of the current poll", $this->plugin_name),
    ...
    '%%user_wordpress_website%%'   		=> __("User's Wordpress Website", $this->plugin_name),
    ...
    '%%poll_pass_count%%'    			=> __("Polls pass count", $this->plugin_name),
    '%%passed_poll_count_per_user%%'   	=> __("Passed polls count per user", $this->plugin_name),
    '%%current_poll_page_link%%'   		=> __("Current polls posted link", $this->plugin_name),
);
    ...
    <div class="container-fluid">
        <form class="ays-poll-form" id="ays-poll-form" method="post">
            ...
            <h1 class="wp-heading-inline">
                ...
                submit_button(__('Cancel', $this->plugin_name), 'ays-button', 'ays_poll_cancel_top', false, array());
                echo $loader_iamge;
				?>
            </h1>
            <div>
            ...
            <div id="tab1" class="ays-poll-tab-content <?= $active_tab == 'General' ? 'ays-poll-tab-content-active' : ''; ?>">
                    ...
                    <div class="col-sm-3 ays-poll-type-block">
                        <div class="form-group row ays-poll-type-block">
                            <label for="ays-poll-answer">
								<?php echo __('Options', $this->plugin_name); ?>
								<a class="ays-add-answer">
	                                <i class="ays_poll_fas ays_poll_fa-plus-square ays-click-once" title="<?= __("Add option", $this->plugin_name); ?>" id="add-answer"></i>
	                            </a>
	                        </label>
                        </div>
                    </div>
                </div>
                <div class="if-choosing poll-type-block form-group row ays-poll-type-block ays-poll-answers-table-scroll-mobile">
                	<div class="col-sm-12">
                		<table class="ays-answers-table" id="ays-answers-table" ays_default_count="<?php echo 2; ?>">
						    <thead>
						        <tr class="ui-state-default">
						            ...
						            <th style="width: 100vw;"><?php echo __('Option', $this->plugin_name); ?></th>
						            <th class="th-350 ays-answer-redirect-row <?php echo ($redirect_after_submit) ? '' : 'ays_poll_display_none'; ?>"><?php echo __('Redirect URL', $this->plugin_name); ?></th>
						    ...
						    <?php
						        ...
						        <tr class="ays-answer-row ui-state-default <?php echo $ays_even_or_not; ?>">
                                    ...
                                    <td class="ays-choosing-answer-container">
                                        <div class="ays_poll_display_flex">
                                            <input type="text" class="ays-text-input ays-answer-value <?php echo $ays_key_enter;?>" name="ays-poll-answers[]" data-id="<?php echo $dac_i;?>" value="<?= __("Option ".($dac_i+1), $this->plugin_name); ?>">
                                            <?php echo $user_add_html; ?>
                ...
                <div class="if-choosing ays-answers-toolbar-bottom poll-type-block" >
                    <label for="ays-poll-answer">
                        <?php echo __('Options', $this->plugin_name); ?>
                        <a class="ays-add-answer">
                            <i class="ays_poll_fas ays_poll_fa-plus-square" title="<?= __("Add option", $this->plugin_name); ?>" id="add-answer"></i>
                        </a>
                    </label>
                </div>
                        ...
                        <div class="form-group row">
                            <div class="col-sm-2">
                                <label for="ays_redirect_after_submit" >
                                    <?php echo __('Answer Redirection',$this->plugin_name)?>
                            ...
                            <div class="col-sm-9">
                                <div class="ays_toggle_target" <?= $poll_allow_answer ? '' : 'style="display:none;"'; ?>>
                                    <div class="form-group row allow_add_answers_not_show_up ays_toggle_parent">
                                        ...
                                        ?>
                                        <div class="col-sm-7 row ays_toggle_target ays_divider_left" <?= ($poll_allow_answer_require) == '' ? 'style="display:none;"' : '' ; ?>>
                                            <div class="col-sm-3">
                                                <label for="ays_poll_require_approve_select_all">
                                                    <?= __('Select all', $this->plugin_name); ?>
                                                    <a class="ays_help" data-toggle="tooltip"
                                                    data-placement="top"
                                                    title="<?= __("If the option is enabled, all the custom answers will be ticked in bulk and will be displayed for the poll on the front end.", $this->plugin_name); ?>">
                                                        <i class="ays_poll_fas ays_poll_fa-info-circle"></i>
                                                    </a>
                                                </label>
                                            </div>
                ...
                <div class="if-voting poll-type-block  form-group row">
                    <div class="col-sm-3">
                        <label for="ays-poll-vote-type">
							<?= __('Options', $this->plugin_name); ?><a class="ays_help" data-toggle="tooltip" data-placement="top" title="<?= __("Select the appearance of the poll.", $this->plugin_name); ?>">
                                <i class="ays_poll_fas ays_poll_fa-info-circle"></i>
                            </a></label>
                    </div>
                ...
                <div class="if-rating poll-type-block  form-group row">
                    <div class="col-sm-3">
                        <label for="ays-poll-rate-type">
							<?= __('Options', $this->plugin_name); ?><a class="ays_help" data-toggle="tooltip" data-placement="top" title="<?= __("Select the appearance and the scale of assessment of the poll.", $this->plugin_name); ?>">
                                <i class="ays_poll_fas ays_poll_fa-info-circle"></i>
                            </a></label>
                    </div>
                    <div class="col-sm-9 answers-col">
                        ...
                        <div class="form-group row">
                            <div class="col-2">
                                <label for="ays_add_f_votes">
                                    ...
                                    <a class="ays_help" data-toggle="tooltip" data-placement="top" title="<?= __("Allow users to add their fake votes to each option.", $this->plugin_name); ?>">
                                        <i class="ays_poll_fas ays_poll_fa-info-circle"></i>
                                    </a>
                                </label>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-sm-12">
                                ...
                                <div class="col-sm-8 ays_divider_left">
	                                ...
	                                <div class="ays_toggle_target ays_divider_top ays_answer_style" style="margin-top: 10px; padding-top: 10px; <?= ($options['enable_answer_style'] == 'on') ? '' : 'display:none;' ?>">
                                        ...
                                        <div id="ays-poll-border-side-box">
                                            <select name="ays_poll_border_side" id="ays-poll-border-side"
                                                    class="ays-select ays_poll_aysDropdown">
                                    ...
                                    <div class="ays_toggle_target ays_divider_top ays_answer_style" style="margin-top: 10px; padding-top: 10px; <?= ($options['enable_answer_style'] == 'on') ? '' : 'display:none;' ?>">
                                        ...
                                        <div id="ays_poll_image_background_size_box">
                                            <select id="ays_poll_image_background_size" name="ays_poll_image_background_size" class="ays-select ays_poll_aysDropdown">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8 ays_divider_left">
                                    <select class="ays_poll_aysDropdown" id="ays_poll_title_alignment" name="ays_poll_title_alignment">
                                    ...
                                    <div>
                                        ...
                                        <div>
                                            ...
                                            <p class="ays_poll_small_hint_text_for_message_variables">
                                                <span><?php echo __( "For 100% leave blank" , $this->plugin_name ); ?></span>
                                            </p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="form-group row">
                                <div class="col-sm-4">
                                    <label for='ays-poll-button-text-color'>
										<?= __('Buttons Text Color', $this->plugin_name); ?>
                                        <a class="ays_help"
                                           data-toggle="tooltip"
                                           data-placement="top"
                                           title="<?= __("Specify the color of the text written inside the poll button.", $this->plugin_name); ?>">
                                            <i class="ays_poll_fas ays_poll_fa-info-circle"></i>
                                        </a>
                                    </label>
                                </div>
                            ...
                            <div class="form-group row">
                                <div class="col-sm-4">
                                    <label for='ays-poll-button-bg-color'>
										<?= __('Buttons Background Color', $this->plugin_name); ?>
                                        <a class="ays_help"
                                           data-toggle="tooltip"
                                           data-placement="top"
                                           title="<?= __("Specify the background color of the poll button.", $this->plugin_name); ?>">
                                            <i class="ays_poll_fas ays_poll_fa-info-circle"></i>
                                        </a>
                                    </label>
                                </div>
                                    ...
                                    <div class="form-group row ays-poll-toggle-image-title-box <?php echo !$style_logo_check ? "display_none" : "";?>">
                                    	<div class="col-sm-4">
				                            <label for="ays_poll_logo_title">
				                                ...
				                                <a class="ays_help" data-toggle="tooltip"
				                                data-placement="top"
				                                title="<?php echo __("Specify the title of the Logo image.", $this->plugin_name); ?>">
				                                    <i class="ays_poll_fas ays_poll_fa-info-circle"></i>
				                                </a>
				                            </label> 
				                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10 ays_divider_left">
                            <button type="button" id="ays_poll_reset_to_default" class="ays-button button-secondary"
                                    id="ays_poll_reset_to_default"><?= __("Reset", $this->plugin_name) ?>
                            </button>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-sm-8" style="margin-left: 15px;">
                        <div class="row">
                            <div style="margin-right: 10px;">
                                <a class="button" href="<?php echo $ays_poll_view_post_url; ?>" target="_blank"><?php echo __( "View Post", $this->plugin_name ); ?> <i class="ays_fa ays_fa_external_link"></i></a>
                            </div>
                            <div>
                                <a class="button" href="<?php echo $ays_poll_edit_post_url; ?>" target="_blank"><?php echo __( "Edit Post", $this->plugin_name ); ?> <i class="ays_fa ays_fa_external_link"></i></a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="form-group row">
                    <div class="col-sm-12 only_pro" style="padding:10px 15px 0 15px;">
                        <div class="pro_features pro_features_popup">
                            <div class="pro-features-popup-conteiner">
                                <div class="pro-features-popup-title">
                                    <?php echo __("Allow Anonymity", $this->plugin_name); ?>
                                </div>
                                <div class="pro-features-popup-content" data-link="https://youtu.be/Awhs309E_vU">
                                    <p>
                                        <?php echo __("Increase the poll response rates by allowing anonymity in your polls. Let your respondents vote in your polls without revealing their identity. This will allow you to get more accurate poll results as the participants will be more confident to express their honest opinions.", $this->plugin_name); ?>
                                    </p>
                                </div>
                        ...
                        <div class="form-group row">
                            <div class="col-sm-3">
                                <label for='ays-poll-allow-anonymity'>
                                    ...
                                    <a class="ays_help ays-poll-zindex-for-pro-tooltip" data-toggle="tooltip" data-placement="top" title="<?= __("It allows participants to respond to your polls without ever revealing their identities, even if they are registered on your website. After enabling the option, the WP User and User IP will not be stored in the database.", $this->plugin_name); ?>">
                                        <i class="ays_poll_fas ays_poll_fa-info-circle"></i>
                                    </a>
                                </label>
                            </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        ...
                        <select id="ays_poll_create_author" class="" name="ays_poll_create_author">
                            ...
                            <?php
                                foreach ($ays_poll_wp_users as $key => $user) :
                                    $poll_user_id = ( isset( $user['ID'] ) && $user['ID'] != '') ? absint( sanitize_text_field( $user['ID'] ) ) : 0;
                                    $poll_user_display_name = ( isset( $user['display_name'] ) && $user['display_name'] != '') ? stripslashes(esc_html( $user['display_name'] )) : '';
                                    $selected = '';
                                    if($poll_user_id == $change_poll_create_author){
                                        $selected = 'selected';
                                    }
                            ?>  
                            <option value="<?php echo $poll_user_id;?>" <?php echo $selected; ?>>
                                            ...
                                            <div class='form-group row'>
                                                <div class='col-sm-5'>
                                                    <label class="form-check-label" for="show_bottom_timer">
                                                        <?= __(' Show timer at the bottom', $this->plugin_name); ?>
                                                        <a class="ays_help" data-toggle="tooltip"
                                                            data-placement="top"
                                                            title="<?= __("If you enable this option, the timer will be displayed at the bottom of the poll instead of the top.", $this->plugin_name); ?>">
                                                            <i class="ays_poll_fas ays_poll_fa-info-circle"></i>
                                                        </a>
                                                    </label>
                                                </div>
				                       ...
				                       <div class="result_btn_see" style="display: <?php echo $showresbtnschedule ? 'flex' : 'none'; ?>;">
				                       		<div class="form-check form-check-inline">
				                            	<label class="form-check-label">
				                                	...
				                                	<span>
			                                        	<?= __('With See Results button', $this->plugin_name); ?>
			                                        </span>
			                                    </label>
				                            </div>
				                            <div class="form-check form-check-inline">
				                            	<label class="form-check-label">
				                                	...
				                                	<span>
			                                        	<?= __('Without See Results button', $this->plugin_name); ?>
			                                        </span>
			                                    </label>
				                            </div>
				                    	</div>					                    
	                    ...
	                    <div class="form-group row">
		                    <div class="col-sm-3">
		                        <label>
									...
									<a class="ays_help ays-poll-zindex-for-pro-tooltip" data-toggle="tooltip" data-placement="top" title="<?= __("You can create custom fields with the following types: text, textarea, number, telephone, date, e-mail, URL, color, checkbox.", $this->plugin_name); ?>">
	                                    <i class="ays_poll_fas ays_poll_fa-info-circle"></i>
	                                </a>
		                        </label>
		                    </div>
                        ...
                        <div class="pro_features pro_features_popup">
                            <div class="pro-features-popup-conteiner">
                                ...
                                <div class="pro-features-popup-content" data-link="https://youtu.be/qdbcla0K8nE">
                                    <p>
                                        <?php echo __("Send confirmation emails after the poll submission to the poll voters. This is the best way to connect to your website visitors and boost stronger relationships.", $this->plugin_name); ?>
                                    </p>
                                    <p>
                                        <?php echo __("There are two ways to send email to the poll voters: Custom and SendGrid. Watch the video to learn more about the functionality.", $this->plugin_name); ?>
                                    </p>
                                </div>
                ...
                <div class="form-group row ays_toggle_parent ays-poll-desc-message-vars-parent">
                    <div class="col-sm-3">
                        ...
                        <p class="ays_poll_small_hint_text_for_message_variables">
                            ...
                            <a href="?page=poll-maker-ays-settings&ays_poll_tab=tab6" target="_blank"><?php echo __( "click here" , $this->plugin_name ); ?></a>
                        </p>
                    </div>
                    ...
                    <div class="col-sm-9 ays_toggle_parent">
	                    <div class="form-group row">
	                    	...
	                    	<div class="col-sm-12 if_poll_hide_result_message ays_toggle_target"  style="margin-top: 15px; <?= isset($options['hide_result_message']) && $options['hide_result_message'] ? '' : 'display:none;'; ?>">
		                        <?php
		                        $res_def_message = isset($poll['type']) && $poll['type'] == 'text' ?  '<p style="text-align: center;">'. __("Thank you!", $this->plugin_name) .'</p>' : '';
		                        echo $poll_message_vars_html;
                ...
                <div class="form-group row ays_toggle_parent">
                    <div class="col-sm-3">
                        <label for="ays_enable_social_links">
                            ...
                            <a class="ays_help" data-toggle="tooltip" title="<?php echo __('Display social media links at the end of the poll to allow users to visit your pages in the Social media.',$this->plugin_name)?>">
                                <i class="ays_poll_fas ays_poll_fa-info-circle"></i>
                            </a>
                        </label>
                    </div>
                    ...
                    <div class="col-sm-8 ays_toggle_target ays_divider_left" style=" <?php echo $enable_social_links ? '' : 'display:none' ?>">
                    	<div class="form-group row">
                            <div class="col-sm-4">
                                <label>
                                    <?php echo __('Heading for social links',$this->plugin_name)?>
                                    <a class="ays_help" data-toggle="tooltip" title="<?php echo __('Text that will be displayed over social links.',$this->plugin_name); ?>">
                                        <i class="ays_poll_fas ays_poll_fa-info-circle"></i>
                                    </a>
                                </label>
                            </div>
                        ...
                        <div class="form-group row">
                            <div class="col-sm-4">
                                <label for="ays_linkedin_link">
                                    ...
                                    <a class="ays_help" data-toggle="tooltip" title="<?php echo __('Linkedin profile or page link for showing after poll finish.',$this->plugin_name)?>">
                                        <i class="ays_poll_fas ays_poll_fa-info-circle"></i>
                                    </a>
                                </label>
                            </div>
                        ...
                        <div class="form-group row">
                            <div class="col-sm-4">
                                <label for="ays_facebook_link">
                                    ...
                                    <a class="ays_help" data-toggle="tooltip" title="<?php echo __('Facebook profile or page link for showing after poll finish.',$this->plugin_name)?>">
                                        <i class="ays_poll_fas ays_poll_fa-info-circle"></i>
                                    </a>
                                </label>
                            </div>
                        ...
                        <div class="form-group row">
                            <div class="col-sm-4">
                                <label for="ays_twitter_link">
                                    ...
                                    <a class="ays_help" data-toggle="tooltip" title="<?php echo __('Twitter profile or page link for showing after poll finish.',$this->plugin_name)?>">
                                        <i class="ays_poll_fas ays_poll_fa-info-circle"></i>
                                    </a>
                                </label>
                            </div>
                        ...
                        <div class="form-group row">
                            <div class="col-sm-4">
                                <label for="ays_vkontakte_link">
                                    ...
                                    <a class="ays_help" data-toggle="tooltip" title="<?php echo __('VKontakte profile or page link for showing after poll finish.',$this->plugin_name)?>">
                                        <i class="ays_poll_fas ays_poll_fa-info-circle"></i>
                                    </a>
                                </label>
                            </div>
                        ...
                        <div class="form-group row">
                            <div class="col-sm-4">
                                <label for="ays_youtube_link">
                                    ...
                                    <a class="ays_help" data-toggle="tooltip" title="<?php echo __('Youtube profile or page link for showing after poll finish.',$this->plugin_name)?>">
                                        <i class="ays_poll_fas ays_poll_fa-info-circle"></i>
                                    </a>
                                </label>
                            </div>
                ...
                <div class="form-group row ays_toggle_parent">
                    <div class="col-sm-3">
                        <label for="ays_poll_enable_answer_redirect_delay">
                            <?= __('Option Redirect Delay', $this->plugin_name) ?>
                            <a class="ays_help" data-toggle="tooltip"
                                    ...
                                    <div style="display: flex;">
                                        <div class="form-check form-check-inline ays_poll_loader_show_results_by">
                                            <label class="form-check-label ays_poll_check_label ays_poll_block_with_hidden_row_show_row_block">
                                                ...
                                                <span><?= __('Bar chart(Google)', $this->plugin_name); ?></span>
                                            </label>
                                        </div>
                                        <div class="form-check form-check-inline ays_poll_loader_show_results_by">
                                            <label class="form-check-label ays_poll_check_label ays_poll_block_with_hidden_row_hide_row_block">
                                                ...
                                                <span><?= __('Bar chart', $this->plugin_name); ?></span>
                                            </label>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row" style="align-items: center; margin-left: 0;">
                                    <div class="col-sm-2">
                                        <label for="ays_poll_show_result_chart_google_height" style="margin: 0">
                                            <?= __('Chart height', $this->plugin_name) ?>
                                            <a class="ays_help" data-toggle="tooltip" data-placement="top" title="<?= __("Set the Results Chart height. Note: The option works only for the Google Bar Chart.", $this->plugin_name); ?>">
                                                <i class="ays_poll_fas ays_poll_fa-info-circle"></i>
                                            </a>
                                        </label>
                                    </div>
                ...
                <div class="form-group row">
                    <div class="col-sm-12 only_pro" style="padding:10px 15px 0 15px;">
                        <div class="pro_features pro_features_popup">
                            <div class="pro-features-popup-conteiner">
                                <div class="pro-features-popup-title">
                                    <?php echo __("Results Message Based on the Answer", $this->plugin_name); ?>
                                </div>
                                <div class="pro-features-popup-content" data-link="https://youtu.be/R7GEAtz-73g">
                                    <p>
                                        <?php echo __("Show an individual approach to every poll respondent and add result messages based on their answers.  Write result messages for every answer option and increase the user experience of your polls in seconds.", $this->plugin_name); ?>
                                    </p>
                                </div>
                        ...
                        <div class='form-group row'>
                            ...
                            <a class="ays_help ays-poll-zindex-for-pro-tooltip" data-toggle="tooltip" data-placement="top" title="<?= __("Refresh the below answers table after adding or removing answer(s) in the General tab.", $this->plugin_name); ?>">
                                <i class="ays_poll_fas ays_poll_fa-info-circle"></i>
                            </a>
                        </div>
                        <hr>
            ...
            <div class="ays_save_buttons_content">
                <h1 class="ays_save_buttons_box_for_mobile" id="ays-save-buttons-box-for-mobile">
                    <?php
                    ...
                    submit_button(__('Cancel', $this->plugin_name), 'ays-button', 'ays_poll_cancel', false, array());
                    echo $loader_iamge;
                ...
                <div class="ays_save_default_button_box">
                    ...
                    <div class="only_pro" style="position: relative; display: inline-block">
                        <div class="pro_features pro_features_popup" style="background: none; box-shadow: none; color: #fff">
                            <div class="pro-features-popup-conteiner">
                                <div class="pro-features-popup-title">
                                    <?php echo __("Save as Default feature of Poll", $this->plugin_name); ?>
                                </div>
                                <div class="pro-features-popup-content" data-link="https://youtu.be/JBKbnrRNviI">
                                    <p>
                                        <?php echo __("You can make the process of creating online polls a fun and easy activity with the Save as Default feature of the WordPress Poll Plugin.", $this->plugin_name); ?>
                                    </p>
                                    <p>
                                        <?php echo __("You just need to click on the Save as default button and, each time, creating a new poll, the system will take the settings and styles of the current poll.", $this->plugin_name); ?>
                                    </p>
                                </div>
                            ...
                            <div class="ays_poll_layer_box_blocks">
                                        ...
                                        <div class="ays_poll_layer_item_title">
                                            <p style="margin:0px;">
                                            	<a class="ays_poll_polls_type_name" href="https://ays-pro.com/wordpress/poll-maker" target="_blank">
                                            		<?php echo  __('Dropdown', $this->plugin_name) ?>
                                            	</a>
                                            <p>
                                            <!-- <a href="https://bit.ly/3P42n1R" style="font-size:12px;font-style: italic;" target="_blank">View demo</a> -->
                                ...
                                <label class='ays-poll-dblclick-layer ays-poll-type-pro-feature'>
                                    ...
                                    <div class="ays_poll_layer_item">
                                     ...
                                     alt="<?= __('Range', $this->plugin_name) ?>">
                                            </div>
                                        </div>
                                        <div class="ays_poll_layer_item_title">
                                            <p style="margin:0px;">
                                            	<a class="ays_poll_polls_type_name" href="https://ays-pro.com/wordpress/poll-maker" target="_blank">
                                            		<?php echo  __('Range', $this->plugin_name) ?>
                                            	</a>
                                            <p>
                                            <!-- <a href="https://bit.ly/3P42n1R" style="font-size:12px;font-style: italic;" target="_blank">View demo</a> -->
                                ...
                                <label class='ays-poll-dblclick-layer ays-poll-type-pro-feature'>
                                    ...
                                    <div class="ays_poll_layer_item">
                                        ...
                                        <div class="ays_poll_layer_item_title">
                                            <p style="margin:0px;">
                                            	<a class="ays_poll_polls_type_name" href="https://ays-pro.com/wordpress/poll-maker" target="_blank">
                                            		<?php echo  __('Versus', $this->plugin_name) ?>
                                            	</a>
                                            <p>
                                            <!-- <a href="https://bit.ly/3P42n1R" style="font-size:12px;font-style: italic;" target="_blank">View demo</a> -->
