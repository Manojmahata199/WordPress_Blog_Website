...
<div class="wrap ays_polls_each_results_list_table">
    ...
    <div class="nav-tab-wrapper">
        <a href="#statistics" class="ays-poll-google-chart nav-tab <?php echo ($ays_poll_tab == 'tab1') ? 'nav-tab-active' : ''; ?>" data-tab="tab1"><?= __('Statistics', $this->plugin_name); ?></a>
        <a href="#poststuff" class="nav-tab <?php echo ($ays_poll_tab == 'tab2') ? 'nav-tab-active' : ''; ?>" data-tab="tab2"><?= __('Results', $this->plugin_name); ?></a>
    </div>
