        ...
        <div class="only_pro" style="position: relative">
            <div class="pro_features pro_features_popup" style="background: none; box-shadow: none; color: #fff">
                <div class="pro-features-popup-conteiner">
                    ...
                    <div class="pro-features-popup-content" data-link="https://youtu.be/DYof2ejoDVQ">
                        <p>
                            <?php echo __("Analyzing poll results is the most important point of creating polls. The plugin supports CSV and XLSX file formats to export the results of your polls.", $this->plugin_name); ?>
                        </p>
                        <p>
                            <?php echo __("Use the feature to analyze poll results and get a better understanding of your website visitors.", $this->plugin_name); ?>
                        </p>
                    </div>
            ...
            <div class="ays-poll-crown-img-container-main">
                <a href="https://ays-pro.com/wordpress/poll-maker/" target="_blank" class="ays-poll-crown-img-container">
                    <button class="disabled-button" style="color: #fff; float: right; margin-right: 5px; cursor: pointer; width: 77px; position: relative; display: flex; justify-content: space-between; align-items: center" title="<?=__('This property available only in PRO version', $this->plugin_name);?>" >
