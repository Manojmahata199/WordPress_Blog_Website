...
<div class="wrap">
    ...
    <div class="container-fluid">
        ...
        <form class="ays-poll-category-form" id="ays-poll-category-form" method="post">
            ...
            <div class="form-group row">
                <div class="col-sm-3">
                    <label for='ays_poll_cat_message'><?= __('Message when no active polls found', $this->plugin_name); ?>
            ...
            <div class="form-group row ays-poll-button-box">
                ...
                <?php
                    if ( $prev_poll_cat_id != "" && !is_null( $prev_poll_cat_id ) ) {
                        ...
                        submit_button(__('Previous Poll Category', $this->plugin_name), 'button ays-poll-next-prev-button-class ays-button ays-poll-category-prev-button', 'ays_poll_category_prev_button', false, $other_attributes);
                    }
                ?>
                <?php
                    if ( $next_poll_cat_id != "" && !is_null( $next_poll_cat_id ) ) {
                        ...
                        submit_button(__('Next Poll Category', $this->plugin_name), 'button ays-poll-next-prev-button-class ays-button', 'ays_poll_category_next_button', false, $other_attributes);
                    }
                ?>
                </div>
            </div>
