        ...
        <div class="comparison">
            <table>
                ...
                <tr>
                    ...
                    <th class="product" style="background:#69C7F1; border-top-left-radius: 5px; border-left:0px;">
                        <span style="display: block">
                            <?php echo __( 'Personal', $this->plugin_name ); ?>
                        </span>
                    ...
                    <th class="product" style="background:#69C7F1;">
                        <span style="display: block">
                            <?php echo __( 'Business', $this->plugin_name ); ?>
                        </span>
                    ...
                    <th class="product" style="border-top-right-radius: 5px; background:#69C7F1;">
                        <span style="display: block">
                            <?php echo __( 'Developer', $this->plugin_name ); ?>
                        </span>
                    ...
                    <th class="product" style="border-top-right-radius: 5px; border-right:0px; background:#69C7F1;">
                        <span style="display: block">
                            <?php echo __('Agency',$this->plugin_name)?>
                        </span>
                ...
                <tr>
                    ...
                    <th class="price-info">
                        <div class="price-now">
                            <span span style="text-decoration: line-through; color: red;">$299</span>
                        </div>
                        <div class="price-now">
                            <span>$249</span>
                        </div>
                ...
                <tr class="compare-row">
                    ...
                    <td><?php echo __( '5 sites', $this->plugin_name ); ?></td>
                ...
                <tr class="compare-row">
                    ...
                    <td><?php echo __( '3 months', $this->plugin_name ); ?></td>
                ...
                <tr>
                    <td></td>
                    <td colspan="4"><?php echo __( 'Allow multivote', $this->plugin_name ); ?></td>
                </tr>
                <tr  class="compare-row">
                    <td><?php echo __( 'Allow multivote', $this->plugin_name ); ?></td>
                    <td><i class="ays_poll_fas ays_poll_fa-check"></i></i></td>
                ...
                <tr>
                    <td> </td>
                    <td colspan="4"><?php echo __( 'VS type of poll (versus)', $this->plugin_name ); ?></td>
                </tr>
                <tr class="compare-row">
                    <td><?php echo __( 'VS type of poll (versus)', $this->plugin_name ); ?></td>
                    <td><span>–</span></td>
                    <td><i class="ays_poll_fas ays_poll_fa-check"></i></i></td>
                    <td><i class="ays_poll_fas ays_poll_fa-check"></i></i></td>
                    <td><i class="ays_poll_fas ays_poll_fa-check"></i></i></td>
                ...
                <tr>
                    <td> </td>
                    <td colspan="4"><?php echo __( 'Ability to add custom option', $this->plugin_name ); ?></td>
                </tr>
                <tr class="compare-row">
                    <td><?php echo __( 'Ability to add custom option', $this->plugin_name ); ?></td>
                    <td><span>–</span></td>
                    <td><i class="ays_poll_fas ays_poll_fa-check"></i></i></td>
                    <td><i class="ays_poll_fas ays_poll_fa-check"></i></i></td>
                    <td><i class="ays_poll_fas ays_poll_fa-check"></i></i></td>
                ...
                <tr>
                    <td></td>
                    <td colspan="4"><?php echo __( 'Extra 4 themes', $this->plugin_name ); ?></td>
                </tr>
                <tr class="compare-row">
                    <td><?php echo __( 'Extra 4 themes', $this->plugin_name ); ?></td>
                    <td><span>–</span></td>
                    <td><i class="ays_poll_fas ays_poll_fa-check"></i></td>
                    <td><i class="ays_poll_fas ays_poll_fa-check"></i></td>
                    <td><i class="ays_poll_fas ays_poll_fa-check"></i></td>
                ...
                <tr>
                    <td></td>
                    <td colspan="4"><?php echo __( 'Vote reason option', $this->plugin_name ); ?></td>
                </tr>
                <tr class="compare-row">
                    <td><?php echo __( 'Vote reason option', $this->plugin_name ); ?></td>
                    <td><span>–</span></td>
                    <td><i class="ays_poll_fas ays_poll_fa-check"></i></td>
                    <td><i class="ays_poll_fas ays_poll_fa-check"></i></td>
                    <td><i class="ays_poll_fas ays_poll_fa-check"></i></td>
                ...
                <tr>
                    <td></td>
                    <td colspan="4"><?php echo __( 'Text instead of results', $this->plugin_name ); ?></td>
                </tr>
                <tr class="compare-row">
                    <td><?php echo __( 'Text instead of results', $this->plugin_name ); ?></td>
                    <td><span>–</span></td>
                    <td><i class="ays_poll_fas ays_poll_fa-check"></i></td>
                    <td><i class="ays_poll_fas ays_poll_fa-check"></i></td>
                    <td><i class="ays_poll_fas ays_poll_fa-check"></i></td>
                ...
                <tr>
                    <td></td>
                    <td colspan="4"><?php echo __( 'Import/Export polls', $this->plugin_name ); ?></td>
                </tr>
                <tr class="compare-row">
                    <td><?php echo __( 'Import/Export polls', $this->plugin_name ); ?></td>
                    <td><span>–</span></td>
                    <td><i class="ays_poll_fas ays_poll_fa-check"></i></td>
                    <td><i class="ays_poll_fas ays_poll_fa-check"></i></td>
                    <td><i class="ays_poll_fas ays_poll_fa-check"></i></td>
                ...
                <tr>
                    <td></td>
                    <td colspan="4"><?php echo __( 'Anonymous poll', $this->plugin_name ); ?></td>
                </tr>
                <tr class="compare-row">
                    <td><?php echo __( 'Anonymous poll', $this->plugin_name ); ?></td>
                    <td><span>–</span></td>
                    <td><i class="ays_poll_fas ays_poll_fa-check"></i></td>
                    <td><i class="ays_poll_fas ays_poll_fa-check"></i></td>
                    <td><i class="ays_poll_fas ays_poll_fa-check"></i></td>
                ...
                <tr>
                    <td></td>
                    <td colspan="4"><?php echo __( 'Password protected poll', $this->plugin_name ); ?></td>
                </tr>
                <tr class="compare-row">
                    <td><?php echo __( 'Password protected poll', $this->plugin_name ); ?></td>
                    <td><span>–</span></td>
                    <td><i class="ays_poll_fas ays_poll_fa-check"></i></td>
                    <td><i class="ays_poll_fas ays_poll_fa-check"></i></td>
                    <td><i class="ays_poll_fas ays_poll_fa-check"></i></td>
                ...
                <tr>
                    <td></td>
                    <td colspan="4"><?php echo __( 'Vote session', $this->plugin_name ); ?></td>
                </tr>
                <tr class="compare-row">
                    <td><?php echo __( 'Vote session', $this->plugin_name ); ?></td>
                    <td><span>–</span></td>
                    <td><i class="ays_poll_fas ays_poll_fa-check"></i></td>
                    <td><i class="ays_poll_fas ays_poll_fa-check"></i></td>
                    <td><i class="ays_poll_fas ays_poll_fa-check"></i></td>
                ...
                <tr>
                    <td></td>
                    <td colspan="4"><?php echo __( 'Messages based on answers', $this->plugin_name ); ?></td>
                </tr>
                <tr class="compare-row">
                    <td><?php echo __( 'Messages based on answers', $this->plugin_name ); ?></td>
                    <td><span>–</span></td>
                    <td><i class="ays_poll_fas ays_poll_fa-check"></i></td>
                    <td><i class="ays_poll_fas ays_poll_fa-check"></i></td>
                    <td><i class="ays_poll_fas ays_poll_fa-check"></i></td>
                ...
                <tr>
                    <td></td>
                    <td colspan="4"><?php echo __( 'Display category shortcode', $this->plugin_name ); ?></td>
                </tr>
                <tr class="compare-row">
                    <td><?php echo __( 'Display category shortcode', $this->plugin_name ); ?></td>
                    <td><span>–</span></td>
                    <td><i class="ays_poll_fas ays_poll_fa-check"></i></td>
                    <td><i class="ays_poll_fas ays_poll_fa-check"></i></td>
                    <td><i class="ays_poll_fas ays_poll_fa-check"></i></td>
                ...
                <tr>
                    <td></td>
                    <td colspan="4"><?php echo __( 'Leaderboard', $this->plugin_name ); ?></td>
                </tr>
                <tr class="compare-row">
                    <td><?php echo __( 'Leaderboard', $this->plugin_name ); ?></td>
                    <td><span>–</span></td>
                    <td><i class="ays_poll_fas ays_poll_fa-check"></i></td>
                    <td><i class="ays_poll_fas ays_poll_fa-check"></i></td>
                    <td><i class="ays_poll_fas ays_poll_fa-check"></i></td>
                ...
                <tr>
                    <td></td>
                    <td colspan="4"><?php echo __( 'Poll creation by user', $this->plugin_name ); ?></td>
                </tr>
                <tr class="compare-row">
                    <td><?php echo __( 'Poll creation by user', $this->plugin_name ); ?></td>
                    <td><span>–</span></td>
                    <td><i class="ays_poll_fas ays_poll_fa-check"></i></td>
                    <td><i class="ays_poll_fas ays_poll_fa-check"></i></td>
                    <td><i class="ays_poll_fas ays_poll_fa-check"></i></td>
                ...
                <tr>
                    <td></td>
                    <td colspan="4"><?php echo __( 'Copy protection', $this->plugin_name ); ?></td>
                </tr>
                <tr class="compare-row">
                    <td><?php echo __( 'Copy protection', $this->plugin_name ); ?></td>
                    <td><span>–</span></td>
                    <td><span>–</span></td>
                    <td><i class="ays_poll_fas ays_poll_fa-check"></i></td>
                    <td><i class="ays_poll_fas ays_poll_fa-check"></i></td>
                ...
                <tr>
                    <td></td>
                    <td colspan="4"><?php echo __( 'Klaviyo integration', $this->plugin_name ); ?></td>
                </tr>
                <tr class="compare-row">
                    <td><?php echo __( 'Klaviyo integration', $this->plugin_name ); ?></td>
                    <td><span>–</span></td>
                    <td><span>–</span></td>
                    <td><span>–</span></td>
                    <td><i class="ays_poll_fas ays_poll_fa-check"></i></td>
                ...
                <tr>
                    <td></td>
                    <td colspan="4"><?php echo __( 'Aweber integration', $this->plugin_name ); ?></td>
                </tr>
                <tr class="compare-row">
                    <td><?php echo __( 'Aweber integration', $this->plugin_name ); ?></td>
                    <td><span>–</span></td>
                    <td><span>–</span></td>
                    <td><span>–</span></td>
                    <td><i class="ays_poll_fas ays_poll_fa-check"></i></td>
                ...
                <tr>
                    <td></td>
                    <td colspan="4"><?php echo __( 'Multilingual polls', $this->plugin_name ); ?></td>
                </tr>
                <tr class="compare-row">
                    <td><?php echo __( 'Multilingual polls', $this->plugin_name ); ?></td>
                    <td><span>–</span></td>
                    <td><span>–</span></td>
                    <td><span>–</span></td>
                    <td><i class="ays_poll_fas ays_poll_fa-check"></i></td>
                ...
                <tr>
                    <td></td>
                    <td colspan="4"><?php echo __( 'Text to speech', $this->plugin_name ); ?></td>
                </tr>
                <tr class="compare-row">
                    <td><?php echo __( 'Text to speech', $this->plugin_name ); ?></td>
                    <td><span>–</span></td>
                    <td><span>–</span></td>
                    <td><span>–</span></td>
                    <td><i class="ays_poll_fas ays_poll_fa-check"></i></td>
