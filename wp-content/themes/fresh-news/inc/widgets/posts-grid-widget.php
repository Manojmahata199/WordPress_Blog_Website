	...
	class Ascendoor_Magazine_Posts_Grid_Widget extends WP_Widget {
		...
		public function __construct() {
			$ascendoor_magazine_grid_widget_ops = array(
				...
				'description' => __( 'Retrive Posts Grid Widgets', 'fresh-news' ),
			);
			parent::__construct(
				'ascendoor_magazine_magazine_grid_widget',
				__( 'Ascendoor Posts Grid Widget', 'fresh-news' ),
		...
		public function form( $instance ) {
			...
			<p>
				...
				<input class="tiny-text" id="<?php echo esc_attr( $this->get_field_id( 'number' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'number' ) ); ?>" type="number" step="1" min="1" max="6" value="<?php echo absint( $grid_post_count ); ?>" size="3" />
			</p>
			<p>
