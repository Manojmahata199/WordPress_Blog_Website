	...
	class Ascendoor_Magazine_Posts_Tile_Widget extends WP_Widget {
		...
		public function __construct() {
			$ascendoor_magazine_tile_widget_ops = array(
				...
				'description' => __( 'Retrive Posts Tile Widgets', 'ascendoor-magazine' ),
			);
			parent::__construct(
				'ascendoor_magazine_magazine_tile_widget',
				__( 'Ascendoor Posts Tile Widget', 'ascendoor-magazine' ),
		...
		public function form( $instance ) {
			...
			<p>
				...
				<input class="tiny-text" id="<?php echo esc_attr( $this->get_field_id( 'number' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'number' ) ); ?>" type="number" step="1" min="1" value="<?php echo absint( $tile_post_count ); ?>" size="3" />
			</p>
			<p>
